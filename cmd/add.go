...
multi cfg file cmd: rsm add -n LT'sBlog -u https://longtao.fun/atom.xml -c ./config1.json,/etc/config2.yaml,~/temp/config3.toml
one cfg file cmd: rsm add -n LT'sBlog -u https://longtao.fun/atom.xml -c config.json
